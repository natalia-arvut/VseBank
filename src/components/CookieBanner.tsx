...
import { COOKIES_META, CookiesContent } from './legalContent'
        ...
        <div className="bg-cream-50 border border-gold-400/50 rounded-2xl shadow-gold-lg p-5 md:p-6">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="tag text-xs mb-1">Cookie</div>
          ...
          <p className="font-sans text-[13px] md:text-sm text-ink-700 leading-relaxed mb-4">
            Технические cookie нужны, чтобы работал твой личный кабинет. Аналитические — чтобы понимать, как улучшить игру. Никаких банковских данных в них нет.{' '}
            <button
              type="button"
